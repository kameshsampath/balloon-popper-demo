...
| 8 | **Streamlit in Snowflake (SiS):** stage **`snowflake/sis/streamlit_app.py`** + **`environment.yml`**, **`CREATE STREAMLIT`** from the stage, go **live**, **grant** `USAGE`. Narrative: **[lab/snowflake-streamlit-sis.md](../lab/snowflake-streamlit-sis.md)**; files: **[snowflake/sis/README.md](../sis/README.md)**. |
